        ...
        <div className="relative w-full max-w-7xl mx-auto">
          ...
          <div className="relative text-center max-w-4xl mx-auto">
            ...
            <div className="inline-flex items-center gap-2 bg-amber-500/10 border border-amber-500/20 rounded-full px-4 py-2 mb-8">
              ...
              <span className="text-amber-300 text-sm font-medium tracking-wider">LA SÉLECTION DU MOMENT</span>
            </div>
            ...
            <p className="text-lg text-amber-100/70 mb-10 max-w-2xl mx-auto italic leading-relaxed font-light">
              Une immersion artistique au cœur de l'intime. Découvrez des récits qui redéfinissent l'élégance de la passion.
            </p>
            ...
            <div className="mt-20 grid grid-cols-3 gap-8 max-w-2xl mx-auto">
              <div className="text-center">
                ...
                <div className="text-gray-500 text-sm">Histoires</div>
              </div>
              <div className="text-center border-x border-gray-800">
                <div className="text-3xl font-bold text-white mb-1">500+</div>
                <div className="text-gray-500 text-sm">Chapitres</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-1">24/7</div>
                <div className="text-gray-500 text-sm">Accès illimité</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gradient-to-b from-transparent via-gray-900/50 to-transparent relative overflow-hidden border-t border-amber-500/20">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl sm:text-2xl font-serif italic text-white mb-6 leading-relaxed max-w-3xl mx-auto">
            La passion n'est pas une émotion qui se vit, c'est une atmosphère qui se respire, un parfum qui s'imprègne sur la peau et dans l'âme.
          </p>
          <p className="text-xs font-semibold tracking-wider text-rose-400 uppercase">— L'ÉCRIN DES DÉSIRS</p>
        </div>
      </section>
