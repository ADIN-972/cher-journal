...
export default function CustomStoryTeaser() {
  ...
  return (
    <section className="relative py-16 px-8 overflow-hidden">
      ...
      <div className="max-w-[1280px] mx-auto px-8 flex flex-col lg:grid lg:grid-cols-[1fr_400px] items-center justify-between gap-16">
        <div className="max-w-2xl space-y-8">
          ...
          <div className="space-y-6 text-lg text-charcoal/80 dark:text-white/70 font-light leading-relaxed">
            ...
            <p className="italic text-xl md:text-2xl text-charcoal dark:text-white/70 leading-relaxed mb-8 newsreader">
              L'auteur recherche sa nouvelle muse. Un portrait, une confidence,
              un frisson... prêtez votre essence pour incarner l'héroïne du
              prochain roman. Un rituel d'immortalité littéraire.
            </p>
            <p>
              Vous avez une histoire sensuelle à partager ? Une protagoniste qui
              vous hante ? Des rêves secrets à explorer ?
            </p>
            <p className="italic">
              Proposez-nous les éléments de{" "}
              <span className="font-medium">votre</span> histoire personnalisée
              :
            </p>
            ...
            <p className="text-sm italic font-medium pt-4">
              Les histoires approuvées seront créées gratuitement. Vous aurez
              accès à votre histoire en bundle spécial et en édition imprimée.
            </p>
          </div>
          <div className="pt-8">
            <button
              ...
              className="bg-brand-prune hover:bg-[#2d1620] text-soft-gold border border-gold/30 px-12 py-4 rounded-xl font-bold tracking-wider uppercase text-sm shadow-xl transition-all transform hover:-translate-y-1
                 hover:text-[#2d1620]
                group relative px-10 py-5  font-bold tracking-[0.2em] text-sm uppercase transition-all duration-500 hover:bg-white hover:scale-105  hover:shadow-[0_0_40px_rgba(212,175,55,0.6)]
