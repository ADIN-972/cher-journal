...
const scopeColors: Record<string, string> = {
  ...
  POV_CHAPTER: "from-rose-500 to-rose-600",
  POV_VOLUME: "from-rose-400 to-rose-500",
...
const bgColors: Record<string, string> = {
  ...
  POV_CHAPTER: "bg-rose-600",
  POV_VOLUME: "bg-rose-500",
...
const scopeLineColors: Record<string, string> = {
  ...
  POV_CHAPTER: "border-rose-800",
  POV_VOLUME: "border-rose-700",
