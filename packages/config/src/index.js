...
exports.config = {
    ...
    // Database
    databaseUrl: process.env.DATABASE_URL || 'postgresql://postgres:postgres@localhost:5432/cher_journal',
    // Session
    ...
    masterEncryptionKey: process.env.MASTER_ENCRYPTION_KEY || 'dev-only-32-byte-key-change-me!!',
    // Stripe
    stripe: {
